...
namespace BattleRaja.Presentation.Gadgets
{
    ...
    public sealed class GadgetPickupVisuals : MonoBehaviour
    {
        ...
        private void Build()
        {
            ...
            CreatePresentationMesh("PickupHalo", PrimitiveType.Cylinder, root, new Vector3(0f, -0.18f, 0f), new Vector3(0.72f, 0.018f, 0.72f), pedestal);
            if (id.IndexOf("dhol", System.StringComparison.OrdinalIgnoreCase) >= 0)
            {
                CreatePresentationMesh("DholBody", PrimitiveType.Cylinder, root, new Vector3(0f, 0.22f, 0f), new Vector3(0.34f, 0.24f, 0.34f), accent, Quaternion.Euler(90f, 0f, 0f));
                CreatePresentationMesh("DholRimL", PrimitiveType.Cylinder, root, new Vector3(-0.22f, 0.22f, 0f), new Vector3(0.12f, 0.08f, 0.12f), highlight, Quaternion.Euler(90f, 0f, 0f));
                CreatePresentationMesh("DholRimR", PrimitiveType.Cylinder, root, new Vector3(0.22f, 0.22f, 0f), new Vector3(0.12f, 0.08f, 0.12f), highlight, Quaternion.Euler(90f, 0f, 0f));
                CreatePresentationMesh("DholStrap", PrimitiveType.Cube, root, new Vector3(0f, 0.22f, -0.18f), new Vector3(0.08f, 0.42f, 0.08f), highlight, Quaternion.Euler(0f, 0f, 24f));
            }
            else if (id.IndexOf("tiffin", System.StringComparison.OrdinalIgnoreCase) >= 0)
            {
                CreatePresentationMesh("TiffinLower", PrimitiveType.Cylinder, root, new Vector3(0f, 0.12f, 0f), new Vector3(0.42f, 0.12f, 0.42f), accent);
                CreatePresentationMesh("TiffinUpper", PrimitiveType.Cylinder, root, new Vector3(0f, 0.34f, 0f), new Vector3(0.32f, 0.10f, 0.32f), highlight);
                CreatePresentationMesh("TiffinHandle", PrimitiveType.Cube, root, new Vector3(0f, 0.53f, 0f), new Vector3(0.12f, 0.18f, 0.12f), accent);
                CreatePresentationMesh("TiffinStripe", PrimitiveType.Cube, root, new Vector3(0f, 0.22f, -0.34f), new Vector3(0.32f, 0.06f, 0.06f), highlight);
            }
            else
            {
                CreatePresentationMesh("UmbrellaPole", PrimitiveType.Cylinder, root, new Vector3(0f, 0.24f, 0f), new Vector3(0.08f, 0.42f, 0.08f), highlight);
                CreatePresentationMesh("UmbrellaCanopy", PrimitiveType.Cylinder, root, new Vector3(0f, 0.58f, 0f), new Vector3(0.55f, 0.10f, 0.55f), accent);
                CreatePresentationMesh("UmbrellaHandle", PrimitiveType.Cube, root, new Vector3(0.12f, 0.14f, 0f), new Vector3(0.08f, 0.22f, 0.08f), highlight, Quaternion.Euler(0f, 0f, -30f));
                CreatePresentationMesh("UmbrellaStripe", PrimitiveType.Cube, root, new Vector3(0f, 0.68f, 0f), new Vector3(0.12f, 0.03f, 0.58f), highlight, Quaternion.Euler(0f, 45f, 0f));
            }
            ...
            CreatePresentationMesh("PickupBeacon", PrimitiveType.Cube, root, new Vector3(0f, 1.08f, 0f), new Vector3(0.055f, 0.72f, 0.055f), highlight);
            CreatePresentationMesh("PickupBeaconTop", PrimitiveType.Cube, root, new Vector3(0f, 1.48f, 0f), new Vector3(0.24f, 0.055f, 0.24f), accent, Quaternion.Euler(0f, 45f, 0f));
        }
