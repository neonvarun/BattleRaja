...
| --- | --- | --- |
| Unity project and package baseline | Passed with evidence | Unity `6000.5.6f1`; latest validated source HEAD `4391f09`; repository validation clean; compile succeeds |
...
| EditMode and PlayMode regression baseline | Passed with evidence | Latest tutorial validation passes 81/81 EditMode and 32/32 PlayMode tests; see `Docs/QA/LATEST_HEAD_BASELINE.md` |
