...
Latest continuation: `78fa990` + `204e4f0` + `678acb0` (2026-08-03). Production-flow
...
| --- | --- | --- |
| Unity project and package baseline | Passed with evidence | Unity `6000.5.6f1`; latest validated runtime source HEAD `78fa990`; Photon Fusion `2.1.1 Stable 2177`; Input System-only handler with legacy-scene compatibility bridge; repository validation clean; see `Docs/QA/LATEST_HEAD_BASELINE.md` |
...
| Android smoke build | Passed with evidence | Current `78fa990` APK (`151,472,675` bytes; SHA-256 `B8D6DCEB124B0CA9DA42A2E341720B7AC7F325FA734FDD2EA3650F9F3B53AF80`) installed/launched only on Lava `ST5GDW23LB004392` (`LAVA LXX508`); Unity activity remained top-resumed with no sampled fatal marker. The optional Play Asset Delivery class-probe warning remains known. |
| Web smoke build | Passed with evidence | Current `78fa990` Web output (`21` files; `133,469,527` bytes; `Web.wasm` SHA-256 `C51E0EBB3B086C16EAA0C079532FC37C0015CD827F437B89C009DF892F4846F6`) built successfully and returned HTTP 200 locally; browser visual/input and human review gates remain open; see `Docs/QA/LATEST_HEAD_BASELINE.md` |
