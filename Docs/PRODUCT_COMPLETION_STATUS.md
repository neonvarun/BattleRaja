...
120-second match diagnostics and a Lava touch-routing probe with limited movement-lesson
attribution are indexed in `Docs/V1_RELEASE_PLAN.md` P22-P24. The
