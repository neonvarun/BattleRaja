...
| Android smoke build | Passed with evidence | Fresh `8f190cd` prefab candidate APK (`151,511,951` bytes; SHA-256 `B485AEA6050CD16093C3A17C77DC8E75484BB7AFFB3875880E36F4110E742B61`) installed/launched only on Lava `ST5GDW23LB004392` (`LAVA LXX508`); Unity activity remained top-resumed with no sampled fatal marker. Memory snapshot: 411,216 KB PSS / 547,836 KB RSS / 82,088 KB Graphics. The optional Play Asset Delivery class-probe warning remains known. |
| Web smoke build | Passed with evidence | Fresh `8f190cd` Web output (`19` files; `133,496,123` bytes; `Web-BazaarBastion.wasm` SHA-256 `C1375376EF0906364B33798E046F719C041ECB1BF0277DBFCA32B91ABA165C68`) built successfully and returned HTTP 200 locally on port 8139; browser visual/input and human review gates remain open; see `Docs/QA/LATEST_HEAD_BASELINE.md` |
