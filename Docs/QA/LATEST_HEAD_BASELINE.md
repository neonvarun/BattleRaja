...
| EditMode tests | 66 passed, 0 failed | `Builds/M11/TestResults/tick-editmode.xml` |
...
| Combat statistics | Instigator-aware events record damage, eliminations, survival time and duplicate-credit prevention; EditMode 66/66 and PlayMode 27/27 pass | `Builds/M11/TestResults/tick-editmode.xml`, `Builds/M11/TestResults/tick-playmode.xml` |
| Aandhi warning/preview | Warning state, remaining warning time and next-radius preview are part of the immutable tick result; EditMode 66/66 and PlayMode 27/27 pass | `Builds/M11/TestResults/tick-editmode.xml`, `Builds/M11/TestResults/tick-playmode.xml` |
| Tick-based attack cooldown | `WeaponCooldownState` and the player attack controller use 30 Hz simulation ticks; EditMode 66/66 and PlayMode 27/27 pass | `Builds/M11/TestResults/tick-editmode.xml`, `Builds/M11/TestResults/tick-playmode.xml` |
...
- Authority/statistics/tick regression: 66 EditMode and 27 PlayMode tests pass after the focused foundation changes.
