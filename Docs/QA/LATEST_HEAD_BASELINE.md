...
| Combat statistics | Instigator-aware events record damage, eliminations, survival time and duplicate-credit prevention; EditMode 65/65 and PlayMode 27/27 pass | `Builds/M11/TestResults/phase1stats-editmode.xml`, `Builds/M11/TestResults/phase1stats-playmode.xml` |
| Aandhi warning/preview | Warning state, remaining warning time and next-radius preview are part of the immutable tick result; EditMode 65/65 and PlayMode 27/27 pass | `Builds/M11/TestResults/phase1stats-editmode.xml` |
