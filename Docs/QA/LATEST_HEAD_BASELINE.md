...
| EditMode tests | 68 passed, 0 failed | `Builds/M11/TestResults/authority-items-editmode-v2.xml` |
...
| Combat statistics | Instigator-aware events record damage, eliminations, survival time and duplicate-credit prevention; EditMode 68/68 and PlayMode 27/27 pass | `Builds/M11/TestResults/authority-items-editmode-v2.xml`, `Builds/M11/TestResults/authority-items-playmode.xml` |
| Aandhi warning/preview | Warning state, remaining warning time and next-radius preview are part of the immutable tick result; EditMode 68/68 and PlayMode 27/27 pass | `Builds/M11/TestResults/authority-items-editmode-v2.xml`, `Builds/M11/TestResults/authority-items-playmode.xml` |
| Tick-based presentation timing | Player movement, Bijli ability, projectile stepping, gadget timers and weapon attack cooldown consume a 30 Hz clock; EditMode 68/68 and PlayMode 27/27 pass | `Builds/M11/TestResults/authority-items-editmode-v2.xml`, `Builds/M11/TestResults/authority-items-playmode.xml` |
| Authority item collection | Pickup availability/respawn and gadget collection are decided in `OfflineMatchAuthority`; EditMode 68/68 and PlayMode 27/27 pass | `Assets/BattleRaja/Core/Domain/MatchItems.cs`, `Builds/M11/TestResults/authority-items-editmode-v2.xml`, `Builds/M11/TestResults/authority-items-playmode.xml` |
...
- Authority/statistics/tick/item regression: 68 EditMode and 27 PlayMode tests pass after the focused foundation changes.
