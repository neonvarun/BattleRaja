...
## Latest exact-current evidence — `7b13f8f` — 2026-08-24

- Validation: **0 errors / 0 warnings**; EditMode **125/125**; PlayMode **67/67**.
- Release-shaped APK: **39,524,160 bytes**, SHA-256
  `B55EF5268E19D7B84FAB14E072769431CD7F20F6A1AFD99009A3C5E1DF1CB733`.
- Release-shaped AAB: **35,351,879 bytes**, SHA-256
  `B84EA775120DA203C6F70D522D316F59224FB7FAF6F5A889EFE13E5C089FDC0F`.
...
- Lava `ST5GDW23LB004392`: release-shaped APK installed and launched to the branded
  menu; full touch route and sustained performance review remain open.
