...
- **Attack + Tiffin proof pass (2026-09-05 late night):** No source change.
  Human-operated two-leg hold-method route on exact APK `98C3FFAE…FBEB`:
  three 700 ms aimed attack holds (once point-blank) and one aimed 700 ms
  Tiffin hold on open ground. Both individual proofs stay open
  (inconclusive, not negative); team combat stayed live and zero scoped
  crash markers (PSS 265,823 KB / RSS 417,432 KB). Full record:
  `Docs/QA/V1_ATTACK_TIFFIN_PROOF_PASS_2026-09-05.md`.
...
- **Hero silhouette and portrait framing pass (2026-09-04):** The saved V1 fighter
  ...
  Maya fan blades). These are editable render-only meshes generated by
  `ProductionArtBuilder`; `ProductionPresentationBuilder` attaches them to the existing
  presentation rig, and no authority, collision or gameplay state moved into the art
  prefabs. `TopDownCameraController` now uses a **1.6** portrait framing cap multiplier,
  giving the Bastion plaza and fighters materially more screen presence on the approved
  tall-phone viewport.

  Static validation remains **0 errors / 0 warnings**. Fresh EditMode is **159/159**
  (XML SHA-256 `CAFECE2084FCB0A73980F51FB486125F2BA9EAE04C24579ADD125D377296827B`) and
  PlayMode is **95/95** for the art contract pass (XML SHA-256
  `1D8CA1AD5C09C82880569C4D9F6AA49BF019D988267CB0E069567FC9F13AE6D9`). The earlier
  framing follow-up also passed **95/95** (XML SHA-256
  `A66ABE558015325098C24EF7486060924FC84E240C71BEC1B7800B62CEDA68A0`). The rebuilt
  APK is **41,667,212 bytes** (SHA-256
  ...
  **37,492,707 bytes** (SHA-256
  ...
  checker passed target SDK 36, offline permissions, ARM64/static 16 KB alignment and
  store-creative dimensions.
  ...
  `675945B1E3CB7C1471CE7C65C299B17A0969104C969D57EE5083F608436FFA04`. Fresh route
  evidence is under `Builds/Local/V1GameplayTruth/Next/hero-framing-20260904/`:
  menu (`0F24911929B8C99AA6D9D0C4FC6B4E45F5055167E25762B1E571369501C396E6`), fighter
  select (`7C49892FFABA807F951A8E84DF28C606EF2959E4AE6D6BB18067B14523008BA`), live 4v4
  (`92B09898FA4CBD3A1C1583A5B9F15A6DC581831C93D011EC9DA81B868AEA9E6A`) and rematch
  (`B8954CF43302A56B669398AC71D91B5D5DF1AD6AC5E1349DF8A9AEECC994DA98`). A bounded
  six-sample/30-second live capture is under
  `Builds/Local/V1GameplayTruth/Next/performance-hero-framing-20260904/`: PSS
  **298,267–300,427 KB**, RSS **410,240–419,944 KB**, graphics PSS
  **89,288–93,392 KB**, raw app CPU **81.8–138%**, CPU/GPU **41.993–42.987 C**,
  battery **74% → 74%**, thermal status **0**, and no configured fatal markers. This is
  bounded shell/compositor evidence, not normalized Unity GPU/GC profiling or endurance
  approval.

  The presentation is still a generated, editable V1 baseline rather than commissioned
  final art/audio. Full all-fighter/tutorial/accessibility/lifecycle comfort, normalized
  performance/endurance, physical 16 KB runtime, permanent identity/signing and owner
  privacy/Data Safety/IARC/cultural/Play approvals remain open; classification remains
...
- **Environment readability and portrait framing refinement (2026-09-04):** The latest
  ...
  **94/94** (XML SHA-256
  `4FA8EA81AB372436B6AB7796C31024262BF2016074FEFF88A812C87899F0A4AE`). A fresh
  current-checkout rebaseline also passed EditMode **159/159** (SHA-256
  `A04D0CC0C31459C241EEF3E3B63A479A43C5EC2B4E5C6BED78D439ECE3CBF9C2`) and PlayMode
  **94/94** (SHA-256
  `E95C6AED5922793791AD7B42064EDB80D782CEEC5AC12DC10A170966D77FB287`), including
  the two-seed × 8,400-tick replay soak with zero divergence. The current
